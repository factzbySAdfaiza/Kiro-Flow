...
from kiro.admin_routes import router as admin_router
from kiro import admin_routes
...
async def lifespan(app: FastAPI):
    ...
    app.state.persistence = get_persistence_provider()
    
    # Link auth manager to admin routes
    admin_routes.auth_manager = app.state.auth_manager
...
if static_path.exists():
    ...
    async def admin_redirect():
        return RedirectResponse(url="/static/dashboard/index.html?tab=system")

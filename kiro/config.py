...
# ==================================================================================================
# Admin Panel & Persistence Settings
# ==================================================================================================

# Admin password for accessing the /admin panel (default: admin)
ADMIN_PASSWORD: str = os.getenv("ADMIN_PASSWORD", "admin")
FIREBASE_ADMIN_UID: Optional[str] = os.getenv("FIREBASE_ADMIN_UID")

# Firebase project ID for persistent storage (optional)
FIREBASE_PROJECT_ID: Optional[str] = os.getenv("FIREBASE_PROJECT_ID")
FIREBASE_COLLECTION: str = os.getenv("FIREBASE_COLLECTION", "kiro-gateway")
FIREBASE_DOCUMENT_ID: str = os.getenv("FIREBASE_DOCUMENT_ID", "credentials")

# Firebase Service Account (JSON string or path to JSON file)
# If set, used for firebase-admin and Firestore authentication.
FIREBASE_SERVICE_ACCOUNT: Optional[str] = os.getenv("FIREBASE_SERVICE_ACCOUNT")
FIREBASE_SERVICE_ACCOUNT_FILE: str = os.getenv("FIREBASE_SERVICE_ACCOUNT_FILE", "firebase-key.json")

# Firebase Client configuration for the frontend
FIREBASE_CLIENT_CONFIG = {
    "apiKey": os.getenv("FIREBASE_API_KEY", "AIzaSyCzIbWOtINFsXwIkBQ3dTagoahJkXLwhiU"),
    "authDomain": os.getenv("FIREBASE_AUTH_DOMAIN", "kiro-gateway-admin-01680582875.firebaseapp.com"),
    "projectId": FIREBASE_PROJECT_ID or "kiro-gateway-admin-01680582875",
    "appId": os.getenv("FIREBASE_APP_ID", "1:367349515876:web:00f7f432571ac769678171")
}
